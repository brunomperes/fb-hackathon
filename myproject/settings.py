...
#DATABASES = {
#    'default': {
#        'ENGINE': 'postgresql_psycopg2' #'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
#        'NAME': os.path.join(BASE_DIR, 'database/#database.sqlite3'),                      # Or path to database file #if using sqlite3.
